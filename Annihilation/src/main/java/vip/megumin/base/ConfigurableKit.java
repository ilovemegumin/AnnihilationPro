...
import vip.megumin.anniPro.kits.IconPackage;
...
public abstract class ConfigurableKit extends Kit
{
	...
	public boolean Initialize()
	{
		...
		{
			String permissionName = "Anni.Kits."+getName();
			Permission perm = Bukkit.getPluginManager().getPermission(permissionName);
			if(perm == null)
			{
